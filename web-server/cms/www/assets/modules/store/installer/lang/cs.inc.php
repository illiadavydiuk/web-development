...
$_lang["status_failed_database_collation_does_not_match"] = 'nezdařilo se - nesoulad porovnání databáze (výchozí hodnota serveru je %1$s). Doporučeno: změňte porovnání databáze v hostingu/phpMyAdmin tak, aby odpovídalo vybranému porovnání UTF-8, a spusťte kontrolu znovu. Pokud je podporováno SET NAMES, můžete pokračovat; nepřepínejte na %1$s jen kvůli úspěšné kontrole.';
