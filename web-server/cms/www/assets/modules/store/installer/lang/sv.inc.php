...
$_lang["status_failed_database_collation_does_not_match"] = 'misslyckades - databaskollationen stämmer inte (serverns standard är %1$s). Rekommenderat: ändra databasens kollation i hostingpanelen/phpMyAdmin så att den matchar vald UTF-8-kollation och kör kontrollen igen. Om SET NAMES stöds kan du fortsätta; byt inte till %1$s bara för att klara denna kontroll.';
