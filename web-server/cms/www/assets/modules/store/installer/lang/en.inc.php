...
$_lang["status_failed_database_collation_does_not_match"] = 'failed - database collation mismatch (server default is %1$s). Recommended: change the database collation in your hosting panel/phpMyAdmin to match the selected UTF-8 collation, then rerun this check. If SET NAMES is supported, you may proceed; do not switch to %1$s only to pass this check.';
