...
$_lang["status_failed_database_collation_does_not_match"] = 'mislyktes - databasekollasjonen stemmer ikke (serverstandard er %1$s). Anbefalt: endre databasekollasjonen i hostingpanelet/phpMyAdmin slik at den samsvarer med valgt UTF-8-kollasjon, og kjør kontrollen på nytt. Hvis SET NAMES støttes, kan du fortsette; ikke bytt til %1$s bare for å bestå denne kontrollen.';
