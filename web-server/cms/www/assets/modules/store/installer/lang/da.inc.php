...
$_lang["status_failed_database_collation_does_not_match"] = 'fejlede - databasens collation stemmer ikke overens (serverens standard er %1$s). Anbefalet: skift databasens collation i dit hostingpanel/phpMyAdmin, så den matcher den valgte UTF-8-collation, og kør testen igen. Hvis SET NAMES understøttes, kan du fortsætte; skift ikke til %1$s kun for at bestå testen.';
