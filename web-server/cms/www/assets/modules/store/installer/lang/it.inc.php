...
$_lang["status_failed_database_collation_does_not_match"] = 'fallita - la collation del database non corrisponde (il valore predefinito del server è %1$s). Consigliato: cambiare la collation del database nel pannello hosting/phpMyAdmin in modo che corrisponda alla collation UTF-8 selezionata, quindi rieseguire il controllo. Se SET NAMES è supportato, è possibile continuare; non passare a %1$s solo per superare questo controllo.';
