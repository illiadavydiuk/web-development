...
$_lang["status_failed_database_collation_does_not_match"] = 'נכשל - התאמת מסד הנתונים אינה תואמת (ברירת המחדל של השרת היא %1$s). מומלץ: שנו את התאמת מסד הנתונים בלוח האחסון/phpMyAdmin כך שתתאים להתאמת UTF-8 שנבחרה, והריצו את הבדיקה שוב. אם SET NAMES נתמך, ניתן להמשיך; אל תעברו ל-%1$s רק כדי לעבור את הבדיקה.';
