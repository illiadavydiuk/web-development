...
$_lang["status_failed_database_collation_does_not_match"] = '問題があります - データベースの照合順序が一致していません（サーバーのデフォルトは %1$s です）。推奨: ホスティングパネルまたは phpMyAdmin でデータベースの照合順序を選択した UTF-8 照合順序に合わせ、もう一度確認してください。SET NAMES がサポートされている場合は続行できますが、この確認を通すためだけに %1$s へ変更しないでください。';
