...
$_lang["status_failed_database_collation_does_not_match"] = 'epäonnistui - tietokannan lajittelu ei täsmää (palvelimen oletus on %1$s). Suositus: muuta tietokannan lajittelu hosting-paneelissa/phpMyAdminissa vastaamaan valittua UTF-8-lajittelua ja suorita tarkistus uudelleen. Jos SET NAMES on tuettu, voit jatkaa; älä vaihda arvoon %1$s vain tämän tarkistuksen läpäisemiseksi.';
